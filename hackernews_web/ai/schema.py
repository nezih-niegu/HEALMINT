...
LINEAR_SERVER_URL = 'https://linear-model-service-nezih-niegu.cloud.okteto.net/v1/models/linear-model:predict'

RESNET_SERVER_URL = 'https://resnet-service-nezih-niegu.cloud.okteto.net/v1/models/resnet:predict'
...
class Query(graphene.ObjectType):
    ...
    def resolve_linear_predictions(self, info, values,  **kwargs):
        ...
        predict_return = '%s'%prediction['predictions']
